                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$ar->sumary}}</td>
                            <td>{{$ar->parent_id==0?'Không có cha':''}}</td>

                            <td>
                                <a href="{{route('article_group.edit',$ar->id)}}" class="btn btn-warning">Sửa</a>
                                <form action="{{ route('article_group.destroy', $ar->id) }}" method="POST"
