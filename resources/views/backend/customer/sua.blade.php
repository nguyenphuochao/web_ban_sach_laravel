            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="email" value="{{$customer->email}}" readonly
                            style="background-color: rgb(179, 174, 174)">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <label for="kichhoat">Kích hoạt:<input type="radio" name="status" @if($customer->status==1)
                            checked @endif id="kichhoat" value="1"></label>
                        <label for="khoa">Khóa:<input type="radio" name="status" id="khoa" @if($customer->status==0)
                            checked @endif value="0"></label>
