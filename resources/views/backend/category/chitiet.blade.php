...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Xem chi tiết - {{$cate_item->name}}</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{route('b.home')}}">Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="{{route('category.index')}}">Danh mục - {{$cate_item->name}}</a></li>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$cate_item->name}}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="">Sumary</label>
                        <input type="text" class="form-control" name="sumary" value="{{$cate_item->sumary}}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
